const config = {
  ...
  EXTRA_REVENUE_PER_DIFFICULTY: 300,
  REVENUE_WEEK_SCALE: 12,
  UNCREATIVITY_DECAY_STRENGTH: 1.4,
  MIN_UNCREATIVITY_DECAY: 0.4,
  MARKET_EXTRA_MULTIPLIER: 0.1,
  LOCATION_EXTRA_MULTIPLIER: 0.02,
